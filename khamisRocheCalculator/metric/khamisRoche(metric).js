function childHeight() {
  ...
  let height = (document.getElementById("height").value) * 0.3937;
  let weight = (document.getElementById("weight").value) * 2.2046;
  let motherHeight = (document.getElementById("motherHeight").value) * 0.3937;
  let fatherHeight = (document.getElementById("fatherHeight").value) * 0.3937;
  ...
  var khamisHeight = (coefficent[0] * weight) + (coefficent[1] * height) + (coefficent[2] * ((motherHeight / 2) + (fatherHeight / 2))) + (coefficent[3]);
  ...
  //Formula for the khamis height Harry Khamis and Dr. Alex Roche made this method this is where the data tables comes in as you can see with coefficient[0], coefficient[1], coefficient[2], and coefficient[3]
   var khamisHeight = khamisHeight * 2.54;
  ...
  if (khamisHeight < 1000000000 && khamisHeight >= 0) {
    console.log("pog");
  ...
  document.getElementById("result").innerHTML = "Your estimated adult height is:" + " " + khamisHeight + " " + "centimeters";
