function cheight() {
  ...
  document.getElementById("result").innerHTML = "If you had a male, his estimated height would be:" + " " + maleheight + " " + "inches";

  //Outputs the male height

  document.getElementById("result2").innerHTML = "If you had a female, her estimated height would be:" + " " + femaleheight + " " + "inches";
